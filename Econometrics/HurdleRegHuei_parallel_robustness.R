...
dir.create(here::here("Econometrics", "regressions", "robustness", "texreg"), recursive = TRUE, showWarnings = FALSE)
write.table(result1, here::here("Econometrics", "regressions", "robustness", "texreg", "Baseline Result for Adaptation"))
write.table(result2, here::here("Econometrics", "regressions", "robustness", "texreg", "Rio Result for Adaptation"))
write.table(result3, here::here("Econometrics", "regressions", "robustness", "texreg", "ClimateFinanceBERT Result for Adaptation"))
...
write.table(result_m1, here::here("Econometrics", "regressions", "robustness", "texreg", "Baseline Result for  Mitigation 103950 obs"))
write.table(result_m2, here::here("Econometrics", "regressions", "robustness", "texreg", "Rio Result for Mitigation"))
write.table(result_m3, here::here("Econometrics", "regressions", "robustness", "texreg", "ClimateFinanceBERT Result for Mitigation"))
